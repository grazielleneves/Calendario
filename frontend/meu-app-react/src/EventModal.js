// Componente EventModal.js (dentro do mesmo arquivo ou em um arquivo separado)
    ...
    return (
      <div className="modal">
        <form onSubmit={(e) => onSubmit(e, { ...event, descricao, start, end })}>
          <input type="text" value={descricao} onChange={(e) => setDescricao(e.target.value)} placeholder="Descrição do Evento" />
